  ...
  const skills = [
    {
      ...
      technologies: ["HTML5", "CSS3", "JavaScript (ES6+)", "TypeScript", "jQuery", "Bootstrap", "SCSS"],
    },
    {
      category: "skills.backend",
      technologies: ["PHP", "MySQL", "APIs REST", "WordPress"],
    },
    {
      category: "skills.tools",
      technologies: ["Git", "GitHub", "PhpMyAdmin", "Adobe Premiere", "CapCut", "Photoshop"],
    },
  ];
            ...
            <div className="grid gap-6">
              {skills.map(({ category, technologies }) => (
                <div key={category} className="card-glass p-6 rounded-xl hover-lift">
                  <h3 className="font-semibold text-lg mb-3 text-primary">{t(category)}</h3>
